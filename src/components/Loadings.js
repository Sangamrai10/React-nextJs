...
export default function Loadings() {
  return (
    <div className='flex relative justify-center item-center mb-4'>
      <div className="bg-gray-200 w-64 h-72 rounded ms-4">
        ...
        <div className="px-4 mt-2 ">
          ...
          <div className="bg-gray-400 w-52 h-4 my-2 rounded animate-pulse"></div>
          <div className="bg-gray-400 w-60 h-4 my-2 rounded animate-pulse"></div>
        </div>
      </div>
    </div>
  )
